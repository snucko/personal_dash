...
export const ICONS = {
    ...
    info: <svg {...iconProps} className="w-5 h-5"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>,
    close: <svg {...iconProps} className="w-6 h-6"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>,
    bruins: <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M21 16.5c0 .38-.21.71-.53.88l-7.97 4.42c-.31.17-.69.17-1 0l-7.97-4.42c-.32-.17-.53-.5-.53-.88v-9c0-.38.21-.71.53-.88l7.97-4.42c.31-.17.69-.17 1 0l7.97 4.42c.32.17.53.5.53.88v9zM12 4.15L5.5 7.76v8.48L12 19.85l6.5-3.61V7.76L12 4.15z M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5z M12 15c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z"/></svg>,
};